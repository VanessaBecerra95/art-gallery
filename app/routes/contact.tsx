...
export default function Contact() {  
  ...
  const validate = () => {  
    ...
    if (!formData.requestType) newErrors.requestType = "El tipo de solicitud es obligatorio";  
    ...
    <main className="main-container">  
      <div className="contact-form-container">  
        ...
        <p className="contact-form-text">  
          ¿Tienes alguna pregunta o comentario? ¡Nos encantaría saber de ti! Por favor, completa el siguiente formulario y te responderemos a la brevedad.  
        </p>  
        <form className="contact-form" onSubmit={handleSubmit}>   
          ...
          />  
          {errors.name && <p className="error-message text-sm text-red-600 dark:text-red-400">{errors.name}</p>}  
          ...
          <input  
            ...
            onChange={handleChange}  
          />  
          {errors.email && <p className="error-message text-sm text-red-600 dark:text-red-400">{errors.email}</p>}  
          ...
          {errors.requestType && <p className="error-message text-sm text-red-600 dark:text-red-400">{errors.requestType}</p>}  
          ...
          <textarea  
            ...
            onChange={handleChange}  
          />  
          {errors.message && <p className="error-message p-2 text-xs text-red-600 dark:text-red-400">{errors.message}</p>}  
